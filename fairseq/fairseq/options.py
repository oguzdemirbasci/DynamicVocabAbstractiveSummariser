...
def get_dynamic_vocab_preprocessing_parser(default_task="translation"):
    parser = get_preprocessing_parser(default_task=default_task)
    parser.add_argument('--L', type=int, default=100, metavar='N',
        help='Nb of tokens to take from the input')
    parser.add_argument('--train_dv_path', default=None, metavar='FILE',
        help='Vocabulary predictions for train set')
    parser.add_argument('--valid_dv_path', default=None, metavar='FILE',
        help='Vocabulary predictions for validation set')
    parser.add_argument('--test_dv_path', default=None, metavar='FILE',
        help='Vocabulary predictions for test set')
    return parser
